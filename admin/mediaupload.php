...
$getfile = "/home/zack/www/media/$deletefile";
if ($deletefile) {
...
<? 
    ...
    if($file == "." || $file == ".." || $file == "index.php" || is_dir($file)) 
        ...
        continue; 
        echo "<a href=media/$file>$file</a> - <a href=index.php?page=Admin&action=mediaupload&deletefile=$file>Delete File</a><br />"; 
