...
$getfile = "/home/zack/www/upload/$deletefile";
if ($deletefile) {
...
<? 
    ...
    if($file == "." || $file == ".." || $file == "index.php" || is_dir($file)) 
        ...
        continue; 
        echo "<a href=upload/$file>$file</a> - <a href=index.php?page=Admin&action=upload&deletefile=$file>Delete File</a><br />"; 
